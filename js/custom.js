...
// Handler for shop link - allow guests to visit shop
document.getElementById('boxShopLink')?.addEventListener('click', function(e){
  // Allow direct navigation to shop without authentication check
  // The link href="/shop" will handle navigation naturally
  // This handler just ensures it works for all users
});
